!(function (global, factory) {
        ...
        jQuery.extend({
            ...
            grep: function (elems, callback, invert) {
                for (
                    ...
                    !callback(elems[i], i) !== callbackExpect &&
    ...
    var Sizzle = (function (window) {
        var i,
            ...
            inDisabledFieldset = addCombinator(
                function (elem) {
                    return (
                        !0 === elem.disabled &&
                        "fieldset" === elem.nodeName.toLowerCase()
                    );
                },
            ...
            if (
                ...
                if (
                    ...
                    if (
                        ...
                        (newContext = context),
                        1 === nodeType && rdescend.test(selector))
                    ) {
                        for (
        ...
        function testContext(context) {
            return (
                context && void 0 !== context.getElementsByTagName && context
            );
        }
                      ...
                      (support.qsa = rnative.test(document.querySelectorAll)) &&
                          ...
                          assert(function (el) {
                              ...
                              input.setAttribute("type", "hidden"),
                                  ...
                                  2 !==
                                      el.querySelectorAll(":enabled").length &&
                                      rbuggyQSA.push(":enabled", ":disabled"),
                                  (docElem.appendChild(el).disabled = !0),
                                  2 !==
                                      el.querySelectorAll(":disabled").length &&
                                      rbuggyQSA.push(":enabled", ":disabled"),
                  ...
                  handler: function (event) {
                      ...
                      if (1 & event.isTrigger && this[type]) {
                          if (saved.length)
                              ...
                              this[type](),
                              saved !== (result = dataPriv.get(this, type)) ||
                              notAsync
        ...
        add: function (elem, types, handler, data, selector) {
            ...
            if (elemData)
                for (
                    ...
                    (type = origType =
                        (tmp = rtypenamespace.exec(types[t]) || [])[1]),
    ...
    function disableScript(elem) {
        return (
            (elem.type =
                (null !== elem.getAttribute("type")) + "/" + elem.type),
            elem
        );
    }
        ...
        function computeStyleTests() {
            if (div) {
                ...
                (pixelPositionVal = "1%" !== divStyle.top),
                    ...
                    (div.style.right = "60%"),
                    (pixelBoxStylesVal =
                        36 === roundPixelMeasures(divStyle.right)),
                    (boxSizingReliableVal =
                        36 === roundPixelMeasures(divStyle.width)),
                    (div.style.position = "absolute"),
                    (scrollboxSizeVal =
                        12 === roundPixelMeasures(div.offsetWidth / 3)),
            ...
            animate: function (prop, speed, easing, callback) {
                var empty = jQuery.isEmptyObject(prop),
                    ...
                    doAnimation = function () {
                        ...
                        (empty || dataPriv.get(this, "finish")) &&
                            anim.stop(!0);
                    };
                return (
            ...
            ajax: function (url, options) {
                ...
                var transport,
                    ...
                    jqXHR = {
                        ...
                        overrideMimeType: function (type) {
                            return (
                                null == completed && (s.mimeType = type), this
                            );
                        },
                ...
                function done(status, nativeStatusText, responses, headers) {
                    ...
                    completed ||
                        ...
                        responses &&
                            (response = (function ajaxHandleResponses(
                                s,
                                jqXHR,
                                responses
                            ) {
                ...
                if (this[0]) {
                    ...
                    if ("fixed" === jQuery.css(elem, "position"))
                        ...
                        offsetParent &&
                            ...
                            (((parentOffset =
                                jQuery(offsetParent).offset()).top +=
