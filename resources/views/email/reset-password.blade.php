                    ...
                    <tr>
                        <td style="text-align:center;">
                            <a href="{{ config('app.app_url') }}" title="logo" target="_blank">
                                <img width="150" src="{{ config('app.app_url') . '/assets/images/logo.png' }}"
                                    title="logo" alt="{{ config('app.name') }}">
                            </a>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            <span>{{ ucfirst($username) }}</span> We cannot simply send you your old
                                            password. A 6-digit password reset code has been generated for you.
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p
                                ...
                                &copy; <strong><span>{{ $app_name }} </span></strong></p>
                        </td>
                    </tr>
                    <tr>
                        <td style="height:80px;">&nbsp;</td>
